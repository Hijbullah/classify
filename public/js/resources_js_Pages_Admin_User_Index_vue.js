...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    deleteUser: function deleteUser($url) {
  ...
  return _c("admin-layout", [
    _c("div", [
      _c(
        ...
        [_vm._v("All Admins and Teachers")]
      ),
      _vm._v(" "),
      _c(
        "div",
                          ...
                          [
                            user.type === "admin"
                              ...
                              : _c(
                                  ...
                                  {
                                    staticClass:
                                      "inline-flex items-center px-3 py-1 bg-blue-500 text-white text-xs font-bold rounded-full uppercase tracking-wider"
                                  },
                                  [_vm._v("Teacher")]
                                )
                          ]
                              ...
                              "button",
                              {
                                ...
                                on: {
                                  click: function($event) {
                                    $event.preventDefault()
                                    _vm.deleteUser(
                                      _vm.route("admin.users.destroy", user.id)
                                    )
                                  }
                                }
                              },
