<template>
    <admin-layout>
        <div>
            <h2 class="text-xl text-gray-900 font-semibold border-b-2 border-gray-900">All Batches</h2>
                ...
                <div class="bg-white rounded shadow overflow-x-auto">
                    <table class="w-full whitespace-no-wrap">
                        ...
                        <tr v-for="batch in batches.data" :key="batch.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
                            ...
                            <td class="border-t px-6 py-2 text-center">
                                <span v-if="batch.status" class="inline-flex items-center px-3 py-1 bg-green-500 text-white text-xs font-bold rounded-full uppercase tracking-wider">Active</span>
                            ...
                            <td class="border-t px-6 py-2 text-center space-x-2">
                                <inertia-link 
                                    :href="route('admin.batches.edit', batch.slug)" 
                        ...
                        <tr v-if="batches.data.length === 0">
                            <td class="border-t px-6 py-4" colspan="4">No batches found.</td>
                        </tr>
